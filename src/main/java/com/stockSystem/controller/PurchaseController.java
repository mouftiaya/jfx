...
public class PurchaseController {
    ...
    private void handlePurchase() {
        ...
        if (selectedProduct == null) {
            showAlert(Alert.AlertType.WARNING, "No Product Selected", "Please select a product to purchase.");
            return;
        }
        ...
        try {
            ...
            // Record purchase transaction (IN)
            stockService.recordTransaction(selectedProduct, Transaction.Type.IN, quantity);

            showAlert(Alert.AlertType.INFORMATION, "Success", 
                "Successfully purchased " + quantity + " units of " + selectedProduct.getName() + ".");
            ...
            showAlert(Alert.AlertType.ERROR, "Error", "Failed to process purchase: " + e.getMessage());
        }
    }
